...
import { TEXLEX_HEADER, TEXLEX_SIGNATURE } from "@/app/asd-engine/report/constants/texlexBoilerplate";
import { FieldStack } from "@/app/asd-engine/report/pdf/components/FieldStack";
import { HorizontalRule } from "@/app/asd-engine/report/pdf/components/HorizontalRule";
...
} from "@/app/asd-engine/report/pdf/utils";
import type { AdhdPdfDraft } from "./types";

const ADHD_PATHWAY = "Attention-Deficit/Hyperactivity Disorder Assessment Pathway";
...
export function AdhdHeader({ draft, logoSrc }: { draft: AdhdPdfDraft; logoSrc: string }) {
  ...
  const assessmentDate = draft.assessmentDate.trim()
    ? formatIsoDate(draft.assessmentDate, "notProvided")
    : "Not provided";
  ...
  const referringPractitioner = resolveMetadataField(
  ...
  return (
    <View>
      ...
      <View style={styles.titleBlock}>
        ...
        <Text style={styles.documentSubtitle}>{ADHD_PATHWAY}</Text>
      </View>
